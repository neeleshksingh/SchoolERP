...
@Component({
  selector: 'app-ops-core',
  imports: [SharedModule],
  templateUrl: './ops-core.component.html',
  styleUrl: './ops-core.component.scss'
})
export class OpsCoreComponent {
  items!: any[];
  ...
  ngOnInit() {
    ...
    //   }
      ...
      this.items = [
        { label: 'Dashboard', icon: 'fas fa-house-user', routerLink: ['/home/modules/ops-core/dashboard'] },
        {
