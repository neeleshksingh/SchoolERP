            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 md:col-span-2">
                    <a (click)="router.navigate(['/pages/landing'], { fragment: 'home' })" class="flex flex-wrap items-center justify-center md:justify-start md:mb-0 mb-6 cursor-pointer">
                        ...
                        <h4 class="font-medium text-3xl text-surface-900 dark:text-surface-0">Teachops</h4>
                    </a>
                </div>
                ...
                <div class="col-span-12 md:col-span-10">
                    <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                        ...
                        <div class="col-span-12 md:col-span-3">
                            ...
                            <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Events<img src="https://primefaces.org/cdn/templates/Teachops/landing/new-badge.svg" alt="badge" class="ml-2" /></a>
