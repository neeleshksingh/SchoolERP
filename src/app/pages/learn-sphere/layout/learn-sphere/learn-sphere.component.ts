...
@Component({
  selector: 'app-learn-sphere',
  imports: [SharedModule],
  templateUrl: './learn-sphere.component.html',
  styleUrl: './learn-sphere.component.scss'
})
export class LearnSphereComponent {
  items!: any[];
  ...
  ngOnInit() {
    ...
    //   }
      ...
      this.items = [
        { label: 'Dashboard', icon: 'fas fa-house-user', routerLink: ['/home/modules/learn-sphere/dashboard'] },
        {
