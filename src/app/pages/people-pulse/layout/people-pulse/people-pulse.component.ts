...
@Component({
  selector: 'app-people-pulse',
  imports: [SharedModule],
  templateUrl: './people-pulse.component.html',
  styleUrl: './people-pulse.component.scss'
})
export class PeoplePulseComponent {
  items!: any[];
  ...
  ngOnInit() {
    ...
    //   }
      ...
      this.items = [
        { label: 'Dashboard', icon: 'fas fa-house-user', routerLink: ['/home/modules/people-pulse/dashboard'] },
        {
