...
@Component({
  selector: 'app-assess-iq',
  imports: [SharedModule],
  templateUrl: './assess-iq.component.html',
  styleUrl: './assess-iq.component.scss'
})
export class AssessIQComponent {
  items!: any[];
  ...
  ngOnInit() {
    ...
    //   }
      ...
      this.items = [
        { label: 'Dashboard', icon: 'fas fa-house-user', routerLink: ['/home/modules/assess-iq/dashboard'] },
        {
